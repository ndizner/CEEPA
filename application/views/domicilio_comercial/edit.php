    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Domicilio Comercial Edit</h3>
            </div>
			<?php echo form_open('domicilio_comercial/edit/'.$domicilio_comercial['id_domicilio_comer']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						<div class="form-group">
							<input type="checkbox" name="dom_comer_estado" value="1" <?php echo ($domicilio_comercial['dom_comer_estado']==1 ? 'checked="checked"' : ''); ?> id='dom_comer_estado' />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_localidad" class="form-control">
								...
								{
									$selected = ($localidad['id_localidad'] == $domicilio_comercial['id_localidad']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_provincia" class="form-control">
								...
								{
									$selected = ($provincia['id_provincia'] == $domicilio_comercial['id_provincia']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="calle" value="<?php echo ($this->input->post('calle') ? $this->input->post('calle') : $domicilio_comercial['calle']); ?>" class="form-control" id="calle" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="numero" value="<?php echo ($this->input->post('numero') ? $this->input->post('numero') : $domicilio_comercial['numero']); ?>" class="form-control" id="numero" />
