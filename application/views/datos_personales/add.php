<?php echo form_open('datos_personales/add',array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="estado_psicofisico" class="col-md-4 control-label">Estado Psicofisico</label>
		<div class="col-md-8">
			<input type="checkbox" name="estado_psicofisico" value="1" id="estado_psicofisico" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="codigo_postal" value="<?php echo $this->input->post('codigo_postal'); ?>" class="form-control" id="codigo_postal" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="contacto_emergencia" value="<?php echo $this->input->post('contacto_emergencia'); ?>" class="form-control" id="contacto_emergencia" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="tel_emergencia" value="<?php echo $this->input->post('tel_emergencia'); ?>" class="form-control" id="tel_emergencia" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="parentesco_emergencia" value="<?php echo $this->input->post('parentesco_emergencia'); ?>" class="form-control" id="parentesco_emergencia" />
