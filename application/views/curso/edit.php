    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Curso Edit</h3>
            </div>
			<?php echo form_open('curso/edit/'.$curso['id_cursos']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						<div class="form-group">
							<input type="checkbox" name="curso_estado" value="1" <?php echo ($curso['curso_estado']==1 ? 'checked="checked"' : ''); ?> id='curso_estado' />
