				...
				<div class="row clearfix">
					<div class="col-md-6">
						<div class="form-group">
							<input type="checkbox" name="usuario_estado" value="1" <?php echo ($usuario['usuario_estado']==1 ? 'checked="checked"' : ''); ?> id='usuario_estado' />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_tipo_usuario" class="form-control">
								...
								{
									$selected = ($tipo_usuario['id_tipo_usuario'] == $usuario['id_tipo_usuario']) ? ' selected="selected"' : "";
