<?php echo form_open('venta/edit/'.$venta['id_ventas'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_condicion_venta" class="form-control">
				...
				{
					$selected = ($condicion_venta['id_cond_venta'] == $venta['id_condicion_venta']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="fecha_operacion" value="<?php echo ($this->input->post('fecha_operacion') ? $this->input->post('fecha_operacion') : $venta['fecha_operacion']); ?>" class="form-control" id="fecha_operacion" />
		</div>
	</div>
	<div class="form-group">
