    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Venta Add</h3>
            </div>
          		...
          		<div class="row clearfix">
					<div class="col-md-6">
						<div class="form-group">
							<input type="checkbox" name="venta_estado" value="1"  id="venta_estado" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_condicion_venta" class="form-control">
								...
								{
									$selected = ($condicion_ventum['id_cond_venta'] == $this->input->post('id_condicion_venta')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="fecha_operacion" value="<?php echo $this->input->post('fecha_operacion'); ?>" class="has-datepicker form-control" id="fecha_operacion" />
