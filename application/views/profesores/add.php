<?php echo form_open('profesor/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_curso" class="form-control">
				...
				{
					$selected = ($curso['id_cursos'] == $this->input->post('id_curso')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_carrera" class="form-control">
				...
				{
					$selected = ($carrera['id_carrera'] == $this->input->post('id_carrera')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_datos_personales" class="form-control">
				...
				{
					$selected = ($dato_personal['id_datos_personales'] == $this->input->post('id_datos_personales')) ? ' selected="selected"' : "";
